    ...
    <div className="flex justify-center items-center h-[1000px] bg-white">
      <div className="w-full max-w-md p-6 bg-white rounded-md">
        ...
        <form>
          ...
          <div className="flex items-center gap-2 mb-6">
            ...
            <p className="text-xs text-gray-600">
              Sign up for emails to get updates from canvas blog on any blog, offers,
              and your Member benefits.
            </p>
          </div>

          <p className="text-xs text-gray-500 mb-6">
            By creating an account, you agree to canvas blog{" "}
        ...
        <div className="text-center text-sm text-gray-600 mt-4">
          Already a Member?{" "}
          <a href="/stayconnected" className="underline">
            Sign In.
          </a>
        </div>
      </div>
